...
var 苦项目层;
var 苦星控制;
var bgmusic=new MusicObject("me/bgmusic.mp3",true);
var 苦加载数据 = [
{name : "num_0",path : "me/num_0.png"}, 
{name : "num_1",path : "me/num_1.png"}, 
{name : "num_2",path : "me/num_2.png"}, 
{name : "num_3",path : "me/num_3.png"}, 
{name : "num_4",path : "me/num_4.png"}, 
{name : "num_5",path : "me/num_5.png"}, 
{name : "num_6",path : "me/num_6.png"}, 
{name : "num_7",path : "me/num_7.png"}, 
{name : "num_8",path : "me/num_8.png"}, 
{name : "num_9",path : "me/num_9.png"}, 
{name : "effect",path : "me/effect.png"}, 
{name : "logo",path : "me/kaishi.jpg"}, 
{name : "inputbox",path : "me/inputbox.png"}, 
{name : "spiritEffect",path : "me/spiritEffect.png"}, 
{name : "b_background",path : "me/beijing.jpg"}, 
{name : "m_background",path : "me/m_background.png"}, 
{name : "stage",path : "me/stage.png"}, 
{name : "chara",path : "me/chara.png"}, 
{name : "bird",path : "me/bird.png"}, 
{name : "gui",path : "me/gui.png"}, 
{name : "window",path : "me/shibai.jpg"}, 
{name : "HP_bg",path : "me/hp_bg.png"},  
{name : "HP_value",path : "me/hp_value.png"},
];
